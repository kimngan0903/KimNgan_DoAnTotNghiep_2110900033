...
namespace OfficePlantCare.Areas.AdminQL.Controllers
{
    public class OrdersController : BaseController
    {
        ...
        public OrdersController(OfficePlantCareContext context, CareScheduleController careSchedulesController)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("OrderId,CustomerId,StaffId,OrderDate,TotalPrice,PaymentMethodId,PaymentDate,PaymentStatus,Status")] Order order)
        {
            ...
            ViewData["StaffId"] = new SelectList(_context.Staffs, "StaffId", "StaffName", order.StaffId);
            return View(order);
        }
