...
namespace OfficePlantCare.Areas.AdminQL.Controllers
{
    public class CustomersController : BaseController
    {
        ...
        public async Task<IActionResult> Index(string name, int? roleId, int page = 1)
        {
            ...
            // Gửi từ khóa tìm kiếm và roleId cho View qua ViewBag
        ...
        public async Task<IActionResult> Create([Bind("CustomerId,CustomerName,Email,Phone,Address,RoleId,PasswordHash,CreatedDate,Status")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerId,CustomerName,Email,Phone,Address,RoleId,PasswordHash,CreatedDate,Status")] Customer customer)
        {
