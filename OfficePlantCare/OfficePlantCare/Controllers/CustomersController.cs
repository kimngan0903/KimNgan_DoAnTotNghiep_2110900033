...
namespace OfficePlantCare.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CustomerId,CustomerName,Email,Phone,Address,CustomerType,RoleId,PasswordHash,CreatedDate,Status")] Customer customer)
        {
