...
namespace OfficePlantCare.Areas.AdminQL.Controllers
{
    public class ServiceDescriptionController : BaseController
    {
        ...
        public ServiceDescriptionController(OfficePlantCareContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DescriptionId,ServiceId,StepNumber,Title,Content,CreatedDate,UpdatedDate")] ServiceDescription serviceDescription)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DescriptionId,ServiceId,StepNumber,Title,Content,CreatedDate,UpdatedDate")] ServiceDescription serviceDescription)
        {
