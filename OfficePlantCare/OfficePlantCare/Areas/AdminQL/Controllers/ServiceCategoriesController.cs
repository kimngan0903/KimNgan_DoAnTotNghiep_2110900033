...
namespace OfficePlantCare.Areas.AdminQL.Controllers
{
    public class ServiceCategoriesController : BaseController
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoryServiceId,CategoryServiceName,Description")] ServiceCategory serviceCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoryServiceId,CategoryServiceName,Description")] ServiceCategory serviceCategory)
        {
