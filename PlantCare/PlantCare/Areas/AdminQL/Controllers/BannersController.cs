...
namespace PlantCare.Areas.AdminQL.Controllers
{
    public class BannersController : BaseController
    {
        ...
        public async Task<IActionResult> Create([Bind("BannerId,Image,Title,CreatedDate,UpdatedDate,Status")] Banner banner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BannerId,Image,Title,CreatedDate,UpdatedDate,Status")] Banner banner)
        {
