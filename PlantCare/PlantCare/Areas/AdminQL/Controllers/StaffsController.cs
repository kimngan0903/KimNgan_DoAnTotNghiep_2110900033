...
namespace PlantCare.Areas.AdminQL.Controllers
{
    public class StaffsController : BaseController
    {
        ...
        public async Task<IActionResult> Create([Bind("StaffId,StaffName,Position,Phone,Email,Avatar,BirthDate,HireDate,Salary,Status")] Staff staff)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StaffId,StaffName,Position,Phone,Email,Avatar,BirthDate,HireDate,Salary,Status")] Staff staff)
        {
            if (id != staff.StaffId)
            {
                return NotFound();
