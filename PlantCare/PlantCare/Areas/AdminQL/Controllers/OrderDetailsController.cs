...
namespace PlantCare.Areas.AdminQL.Controllers
{
    public class OrderDetailsController : BaseController
    {
        ...
        {
            var officePlantCareContext = _context.OrderDetails.Include(o => o.Order).Include(o => o.Product).Include(o => o.Service);
        ...
        public async Task<IActionResult> Create([Bind("OrderDetailId,OrderId,ServiceId,ProductId,Address,Quantity,Price,TotalPrice,Status")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderDetailId,OrderId,ServiceId,ProductId,Address,Quantity,Price,TotalPrice,Status")] OrderDetail orderDetail)
        {
