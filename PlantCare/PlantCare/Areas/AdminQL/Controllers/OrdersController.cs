...
namespace PlantCare.Areas.AdminQL.Controllers
{
    public class OrdersController : BaseController
    {
        ...
        {
            var officePlantCareContext = _context.Orders.Include(o => o.Customer).Include(o => o.PaymentMethod).Include(o => o.Staff);
        ...
        public async Task<IActionResult> Create([Bind("OrderId,CustomerId,StaffId,OrderDate,TotalAmount,Discount,PaymentMethodId,PaymentDate,PaymentStatus,Status")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,CustomerId,StaffId,OrderDate,TotalAmount,Discount,PaymentMethodId,PaymentDate,PaymentStatus,Status")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
