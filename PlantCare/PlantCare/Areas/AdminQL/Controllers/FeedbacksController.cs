...
namespace PlantCare.Areas.AdminQL.Controllers
{
    public class FeedbacksController : BaseController
    {
        ...
        {
            var officePlantCareContext = _context.Feedbacks.Include(f => f.Customer).Include(f => f.Product).Include(f => f.Service);
        ...
        public async Task<IActionResult> Create([Bind("FeedbackId,CustomerId,ProductId,ServiceId,FeedbackDate,Rating,Content,Status")] Feedback feedback)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FeedbackId,CustomerId,ProductId,ServiceId,FeedbackDate,Rating,Content,Status")] Feedback feedback)
        {
